...
@Service
@Profile("!bfcrg")
public class KafkaConsumerServiceWithConsumerFilter {

    private static final String topic = "${kafka.topic}";
    private static final String kafkaConsumerGroupId = "${spring.kafka.consumer.group-id}";
    private final Logger logger = LoggerFactory.getLogger(KafkaConsumerServiceWithConsumerFilter.class);
