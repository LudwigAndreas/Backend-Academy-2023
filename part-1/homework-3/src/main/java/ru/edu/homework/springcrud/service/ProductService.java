...
public interface ProductService {
    ...
    Product createProduct(Product productDto) throws AlreadyExistsException;

    Product updateProduct(String partNumber, Product productDto) throws NotFoundException;
